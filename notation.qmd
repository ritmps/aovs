...
* **Estimations and Decorations:** Approximated or estimated fields are marked with a wide hat (e.g., $\widehat{Z}$ for estimated depth, $\widehat{\mathbf{N}}$ for estimated normals).
